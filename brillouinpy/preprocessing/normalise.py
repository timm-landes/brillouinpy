...
class Vector(PreprocessingStep):
    ...
    pixelwise : bool
        ...
        the spectra with the largest norm in the given :class:`brillouinpy.SpectralContainer` instance.
    """
...
class AUC(PreprocessingStep):
    ...
    pixelwise : bool
        ...
        the curve of the spectrum with the largest one in the given :class:`brillouinpy.SpectralContainer` instance.
    """
