...
def save(filename: str, **savefig_kwargs):
    """
    Save the current Matplotlib figure to the specified file path.

    Parameters
    ----------
    filename : str
        The path where the current figure should be saved.
    **savefig_kwargs :
        Additional parameters for the `matplotlib.pyplot.savefig` method.
    """
...
def peaks(spectrum: Spectrum,
          *,
          title: str = "Brillouin spectra",
          xlabel: str = 'Brillouin shift (GHz)',
    ...
    title : str, optional
        The title of the plot. Default is ``'Brillouin spectra'``.
    xlabel : str, optional
        The x-axis label of the plot. Default is ``'Brillouin shift (GHz)'``.
    ylabel : str, optional
...
def mean_spectra(
    ...
    **kwargs :
    ...
    return _core.spectra_plot_wrapper(_core.plot_species_mean, genus_data, label=label, plot_type=plot_type,
                                      title=title, xlabel=xlabel, ylabel=ylabel, dist=dist, color=color, yscale = yscale, **kwargs)
...
def image(
        ...
        *,
        ...
        title: Union[str, List[str]] = "Brillouin image",
    ...
    """
    Visualising imaging Brillouin data.
    ...
    title : Union[str, List[str]], optional
        The plot title(s) to use for each plot. Default is ``'Brillouin image'``.
...
def volume(
        ...
        *,
        ...
        color=None,
        title: Union[str, List[str]] = "Brillouin volume",
        xlabel: Union[str, List[str]] = None,
        ylabel: Union[str, List[str]] = None,
    ...
    """
    Visualising volumetric Brillouin data.
    ...
    threshold : Union[Number, List[Number]], optional
        If provided, all values less than the given threshold will be discarded, i.e. set to the minimum value in the data.
    title : Union[str, List[str]], optional
        The plot title(s) to use for each plot. Default is ``'Brillouin volume'``.
    xlabel : Union[str, List[str]], optional
        The x-axis label(s) to use for each plot. Default is ``None``, i.e. no label.
    ylabel : Union[str, List[str]], optional
        The y-axis label(s) to use for each plot. Default is ``None``, i.e. no label.
