...
def plot_species_mean(species, plot_axis=plt, offset=0, dist=True, **plt_kwargs):
    ...
    with warnings.catch_warnings():
        ...
        mu = np.nanmean(spectral_data, axis=0)
...
def spectra_plot_wrapper(plotting_function, genus, plot_type, yscale = 'log', **kwargs):
    ...
    if plot_type == "single" or len(genus) == 1:
        ax = single_plot(plotting_function, genus, **kwargs)
