...
if __name__ == '__main__':
    ...
    plt.plot(pp_brillouin_data.spectral_axis, bp.analysis.fitmodel._DHO_1(pp_brillouin_data.spectral_axis, *[        # Give the algorithm a good starting point, must match the lenght (expected_peaks*3)+2
                                           0.001,   # Amplitude
